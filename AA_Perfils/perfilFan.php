...
<html>
    ...
    <body>
        <?php if ($tipoSession == 3) { ?>
                ...
                <div class="contenty">
                    ...
                    <div class="topPerfil">
                        ...
                        <div class="modify">
                            ...
                            <b>Genero:</b> <?php
                            $generoFan = selectGeneroT(selectId($userSession));
                            if ($generoFan == 'w') {
                                echo 'Mujer';
                            } else if ($generoFan == 'm') {
                                echo 'Hombre';
                            ...
                            ?> <br>
                            <b>Fecha Nacimiento:</b> <?php echo selectfechaT(selectId($userSession)); ?>
                    ...
                    <form class="formFanC" action="" method="post">
                        ...
                        <b>Ciudad:</b> <?php echo utf8_encode(selectCiudadS($userSession)); ?><br>
                        <b>Genero:</b> <?php
                        $generoFan = selectGeneroT(selectId($userSession));
                        if ($generoFan == 'w') {
                            echo 'Mujer';
                        ...
                        ?> <br>
                        <b>Fecha Nacimiento:</b> <?php echo selectfechaT(selectId($userSession)); ?><br>
                        <img class="imgClose" height="15px" src="../picturesMusic/cancel.png" alt=""/>
                        <br><input class="doneBut" type="submit" name="modify" value="Hecho">
            ...
            echo 'No eres un fan! No puedes ver esta pagina!';
        }
        ?>
